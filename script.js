...
/*
    Mouse Animation with one small and large circle that increase and decrease
*/
const mousceCircleFunction = (x, y) => {
...
const stickyElement = (x, y, hoveredEl) => {
    /*
    Sticky Element
    The area where  the cursor catches the wheel
    */
    ...
    if (hoveredEl.classList.contains("sticky")) {
        ...
        /**
         * If cursor is hovering over the wheel then catches it 
         */

        if (hoveredEl.offsetTop <= hoveredElPosition[0] - 400 ||
            hoveredEl.offsetTop >= hoveredElPosition[0] + 200 ||
            hoveredEl.offsetLeft <= hoveredElPosition[1] - 200 ||
            hoveredEl.offsetLeft >= hoveredElPosition[1] + 200) {
...
/**
 * After scrolling page progress is "loading", clockwise
 **/
...
/**
 * After clicking on the circle it teleports to the next section
 *  */
...
const aboutMeTextContent = "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Facilis illo quos voluptate iste sit! Eaque excepturi molestias consequatur dolor recusandae quaerat minima magni, minus, adipisci illo eveniet quo, reiciendis iste?";
...
Array.from(aboutMeTextContent).forEach((char) => {
    ...
    span.addEventListener("mouseenter", (e) => {
        e.target.style.animation = "aboutMeTextAnim 6s infinite";
    });
});
...
projects.forEach((project, i) => {
    ...
    // Big Project Image
    // After click in project, a big img project shows
    // Add a "close"
    project.addEventListener("click", () => {
        ...
        // This line give a path of img project
...
//Create Boolen value for show more and show less project
let showHidenBoolen = true;
...
projectsBtn.addEventListener("click", (e) => {
    ...
    showHidenBoolen = !showHidenBoolen;
});
...
// Section 5
// Form
const takeFormHeading = document.querySelector(".form-heading");
const takeFormInputs = document.querySelectorAll(".contact-form-input");

takeFormInputs.forEach((input) => {
    input.addEventListener("focus", () => {
        takeFormHeading.style.opacity = "0";
        setTimeout(() => {
            takeFormHeading.textContent = `Your ${input.placeholder}`;
            takeFormHeading.style.opacity = "1";
        }, 300);
    });
    ...
    input.addEventListener("blur", () => {
        takeFormHeading.style.opacity = "0";
        setTimeout(() => {
            takeFormHeading.textContent = "Let's Talk";
            takeFormHeading.style.opacity = "1";
        }, 300);
    });
});
...
setInterval(() => {
    const firstIcon = slideshow.firstElementChild; // First icon is selected

    firstIcon.classList.add("faded-out");

    const takeMiddleIcon = slideshow.children[3];

    takeMiddleIcon.classList.add("light");

    takeMiddleIcon.previousElementSibling.classList.remove("light");
